...
Connection ~ 950  3150
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR01
U 1 1 52D43B6B
P 2200 3350
...
$EndComp
$Comp
L CP-RESCUE-PIC24_USB_IR_Transmitter C1
U 1 1 52D43BC9
P 1200 1350
...
$EndComp
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR04
U 1 1 52D43BDC
P 1200 1650
...
D-
$Comp
L C-RESCUE-PIC24_USB_IR_Transmitter C2
U 1 1 52D44076
P 8850 3950
...
F 3 "" H 8850 3950 60  0000 C CNN
	...
	0    -1   -1   0   
$EndComp
Text GLabel 1450 5850 2    60   Output ~ 0
~MCLR~
Wire Wire Line
	1100 5850 1450 5850
Wire Wire Line
...
Wire Wire Line
	1750 6050 1750 6300
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR05
U 1 1 52D450A4
P 1750 6300
F 0 "#PWR05" H 1750 6300 30  0001 C CNN
...
Wire Wire Line
	1100 6250 1400 6250
Text GLabel 1400 6150 2    60   Output ~ 0
PGD
Text GLabel 1400 6250 2    60   BiDi ~ 0
PGC
Text GLabel 5350 1100 0    60   Input ~ 0
~MCLR~
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR06
U 1 1 52D45877
P 10800 4000
...
$Comp
L R-RESCUE-PIC24_USB_IR_Transmitter R4
U 1 1 52D4596A
P 10800 2750
...
$EndComp
$Comp
L LED-RESCUE-PIC24_USB_IR_Transmitter D3
U 1 1 52D45985
P 10800 3250
...
Wire Wire Line
	5250 1750 5550 1750
$Comp
L R-RESCUE-PIC24_USB_IR_Transmitter R3
U 1 1 52D45E25
P 4450 5450
...
$EndComp
$Comp
L LED-RESCUE-PIC24_USB_IR_Transmitter D2
U 1 1 52D45E2B
P 4450 5950
...
Wire Wire Line
	4450 4200 4450 5200
$Comp
L R-RESCUE-PIC24_USB_IR_Transmitter R1
U 1 1 52D45EB1
P 1650 1200
...
$EndComp
$Comp
L LED-RESCUE-PIC24_USB_IR_Transmitter D1
U 1 1 52D45EB7
P 1650 1700
...
Wire Wire Line
	1650 850  1650 950 
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR08
U 1 1 52D45EC1
P 1650 1950
...
$EndComp
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR010
U 1 1 52D4649C
P 8350 3450
...
$EndComp
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR011
U 1 1 52D464B4
P 3700 5050
...
U 1 1 52D46642
P 750 6100
F 0 "P1" V 700 6100 60  0000 C CNN
F 1 "CONN_6" V 800 6100 60  0000 C CNN
F 2 "Pin_Headers:Pin_Header_Angled_1x06" H 750 6100 60  0001 C CNN
...
$EndComp
$Comp
L R-RESCUE-PIC24_USB_IR_Transmitter R5
U 1 1 52D469B5
P 3800 4500
...
$Comp
L R-RESCUE-PIC24_USB_IR_Transmitter R6
U 1 1 52D46B46
P 3950 4500
...
U 1 1 52D8FEBD
P 750 7250
F 0 "P7" V 700 7250 60  0000 C CNN
F 1 "CONN_8" V 800 7250 60  0000 C CNN
F 2 "" H 750 7250 60  0001 C CNN
F 3 "" H 750 7250 60  0000 C CNN
	1    750  7250
	-1   0    0    -1  
$EndComp
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR015
U 1 1 52D8FECF
P 1300 7650
F 0 "#PWR015" H 1300 7650 30  0001 C CNN
...
U 1 1 52D8FF66
P 1300 6750
F 0 "#PWR016" H 1300 6840 20  0001 C CNN
...
Wire Wire Line
	1100 7600 1600 7600
Text GLabel 1600 7400 2    60   BiDi ~ 0
SDA
Text GLabel 1600 7500 2    60   BiDi ~ 0
SCL
Text GLabel 1600 7600 2    60   Input ~ 0
~LCD_RESET~
...
$EndComp
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR019
U 1 1 53DC0948
P 5450 7300
...
Wire Wire Line
	5450 7200 5450 7300
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR020
U 1 1 53DC0A13
P 6000 7300
...
$EndComp
$Comp
L C-RESCUE-PIC24_USB_IR_Transmitter C13
U 1 1 53DC0A22
P 6000 6950
...
U 1 1 53DEBDEC
P 1200 5250
F 0 "#PWR021" H 1200 5210 30  0001 C CNN
F 1 "+3,3V" H 1200 5360 30  0000 C CNN
...
$EndComp
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR024
U 1 1 53EA6786
P 4400 4000
...
Wire Wire Line
	3100 850  3100 1700
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR025
U 1 1 53EA8972
P 3450 2000
...
Wire Wire Line
	9550 3950 9550 4750
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR028
U 1 1 53EB3792
P 9550 4750
...
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR029
U 1 1 53EB8094
P 9800 4600
...
VOUTB
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR030
U 1 1 53EB8CF7
P 9350 5300
...
$EndComp
$Comp
L R-RESCUE-PIC24_USB_IR_Transmitter R13
U 1 1 53EB8D1B
P 9350 4950
...
IR_LED
$Comp
L R-RESCUE-PIC24_USB_IR_Transmitter R14
U 1 1 53EF297E
P 2250 2250
...
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR033
U 1 1 53EFE3A1
P 4450 6200
...
VOUTA
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR034
U 1 1 52D43B2E
P 950 3350
...
VOUT_TEMP_SEMS
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR035
U 1 1 53ECDE47
P 6700 6150
...
$EndComp
$Comp
L C-RESCUE-PIC24_USB_IR_Transmitter C14
U 1 1 53ECF8B3
P 6700 5850
...
U 1 1 54641A2F
P 2500 4100
F 0 "U6" H 2650 4450 60  0000 C CNN
F 1 "24C16" H 2700 3750 60  0000 C CNN
F 2 "SMD_Packages:SOIC-8-N" H 2500 4100 60  0001 C CNN
F 3 "" H 2500 4100 60  0000 C CNN
	1    2500 4100
	1    0    0    -1  
$EndComp
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR037
U 1 1 54641AA4
P 2500 4700
...
U 1 1 5464229D
P 2500 3500
F 0 "#PWR038" H 2500 3460 30  0001 C CNN
...
Wire Wire Line
	2500 3500 2500 3600
Text GLabel 3250 4300 2    60   BiDi ~ 0
SDA
Text GLabel 3250 4200 2    60   BiDi ~ 0
SCL
Wire Wire Line
	3200 4200 3250 4200
Wire Wire Line
	3200 4300 3250 4300
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR039
U 1 1 54642FFC
P 3250 4050
F 0 "#PWR039" H 3250 4050 30  0001 C CNN
...
Wire Wire Line
	3250 4000 3250 4050
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR040
U 1 1 54643197
P 1750 4200
F 0 "#PWR040" H 1750 4200 30  0001 C CNN
...
$Comp
L R-RESCUE-PIC24_USB_IR_Transmitter R18
U 1 1 546436E1
P 1300 3900
F 0 "R18" V 1380 3900 40  0000 C CNN
F 1 "0R" V 1307 3901 40  0000 C CNN
F 2 "SMD_Packages:SMD-0603_r" V 1230 3900 30  0001 C CNN
F 3 "" H 1300 3900 30  0000 C CNN
	1    1300 3900
	1    0    0    -1  
$EndComp
$Comp
L R-RESCUE-PIC24_USB_IR_Transmitter R19
U 1 1 5464377C
P 1300 4500
F 0 "R19" V 1380 4500 40  0000 C CNN
F 1 "0R" V 1307 4501 40  0000 C CNN
F 2 "SMD_Packages:SMD-0603_r" V 1230 4500 30  0001 C CNN
F 3 "" H 1300 4500 30  0000 C CNN
	1    1300 4500
	1    0    0    -1  
$EndComp
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR041
U 1 1 54643B72
P 1300 4800
F 0 "#PWR041" H 1300 4800 30  0001 C CNN
...
U 1 1 54644014
P 1300 3600
F 0 "#PWR042" H 1300 3560 30  0001 C CNN
...
Wire Wire Line
	1300 3650 1300 3600
$Comp
L C-RESCUE-PIC24_USB_IR_Transmitter C15
U 1 1 5464427C
P 1650 3900
F 0 "C15" H 1650 4000 40  0000 L CNN
F 1 "100n" H 1656 3815 40  0000 L CNN
F 2 "SMD_Packages:SMD-0603_c" H 1688 3750 30  0001 C CNN
...
U 1 1 5464A69F
P 3100 6150
F 0 "U7" H 3100 5800 60  0000 C CNN
F 1 "TCN75" H 3100 6400 60  0000 C CNN
F 2 "SMD_Packages:SOIC-8-N" H 3100 5800 60  0001 C CNN
F 3 "" H 3100 5800 60  0000 C CNN
	1    3100 6150
	-1   0    0    -1  
$EndComp
Text GLabel 3700 6150 2    60   BiDi ~ 0
SCL
Text GLabel 3700 6050 2    60   BiDi ~ 0
SDA
Wire Wire Line
	3600 6050 3700 6050
Wire Wire Line
	3600 6150 3700 6150
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR043
U 1 1 5464ADEE
P 3700 6700
F 0 "#PWR043" H 3700 6700 30  0001 C CNN
...
$EndComp
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR044
U 1 1 5464AED8
P 2550 6450
F 0 "#PWR044" H 2550 6450 30  0001 C CNN
...
U 1 1 5464AF03
P 2550 5800
F 0 "#PWR045" H 2550 5760 30  0001 C CNN
...
$Comp
L R-RESCUE-PIC24_USB_IR_Transmitter R20
U 1 1 54651E19
P 2100 6150
F 0 "R20" V 2180 6150 40  0000 C CNN
F 1 "0R" V 2107 6151 40  0000 C CNN
F 2 "SMD_Packages:SMD-0603_r" V 2030 6150 30  0001 C CNN
F 3 "" H 2100 6150 30  0000 C CNN
	1    2100 6150
	1    0    0    -1  
$EndComp
$Comp
L R-RESCUE-PIC24_USB_IR_Transmitter R21
U 1 1 54651E1F
P 2100 6750
F 0 "R21" V 2180 6750 40  0000 C CNN
F 1 "0R" V 2107 6751 40  0000 C CNN
F 2 "SMD_Packages:SMD-0603_r" V 2030 6750 30  0001 C CNN
F 3 "" H 2100 6750 30  0000 C CNN
	1    2100 6750
	1    0    0    -1  
$EndComp
$Comp
L GND-RESCUE-PIC24_USB_IR_Transmitter #PWR046
U 1 1 54651E25
P 2100 7050
F 0 "#PWR046" H 2100 7050 30  0001 C CNN
...
U 1 1 54651E32
P 2100 5850
F 0 "#PWR047" H 2100 5810 30  0001 C CNN
F 1 "+3,3V" H 2100 5960 30  0000 C CNN
...
Wire Wire Line
	2100 5900 2100 5850
$Comp
L C-RESCUE-PIC24_USB_IR_Transmitter C16
U 1 1 54651E39
P 2450 6150
F 0 "C16" H 2450 6250 40  0000 L CNN
F 1 "100n" H 2456 6065 40  0000 L CNN
F 2 "SMD_Packages:SMD-0603_c" H 2488 6000 30  0001 C CNN
